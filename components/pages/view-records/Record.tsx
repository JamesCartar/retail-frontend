  ...
  return (
    ...
    >
      <div className="rt-flex rt-justify-between rt-items-center">
        ...
        <span className="rt-font-inter rt-text-[0.9375rem] rt-leading-none">
          {formatNumber(record.amount!)} Ks
        </span>
      </div>
      <div className="rt-font-inter rt-text-[0.9375rem] rt-flex rt-justify-between rt-items-center rt-leading-none">
